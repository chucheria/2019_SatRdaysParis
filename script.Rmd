...
Neo4j CSV import looks for your files in your neo4j import folder so you should move them there.

```{r source_data, include=F}
path <- '/Users/Beardicion/Downloads/neo4j-community-3.5.2/import/'
from <- '/Users/Beardicion/Documents/theterminator/src/graphmodel/'
setwd(from)
file.copy(c('laliga.csv', 'premier.csv'), path)
```
...
on_load_query <- 'MERGE (g:Game {date: line.Date, name: line.Game, home_score: line.FTHG, away_score: line.FTAG, season: line.Season})
  ...
  MERGE (l)-[:FROM]->(c);'
# Send the csv 
load_csv(url = "file:/premier.csv", 
         con = con, header = TRUE, periodic_commit = 50, 
         as = "line", on_load = on_load_query)
load_csv(url = "file:/laliga.csv", 
         con = con, header = TRUE, periodic_commit = 50, 
         as = "line", on_load = on_load_query)
